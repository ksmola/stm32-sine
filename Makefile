...
MKDIR_P     = mkdir -p
TERMINAL_DEBUG ?= 0
CFLAGS		= -Os -Wall -Wextra -Iinclude/ -Iinclude/nanopb -Ilibopeninv/include -Ilibopencm3/include \
...
CPPFLAGS    = -Os -Wall -Wextra -Iinclude/ -Ilibopeninv/include -Iinclude/nanopb -Ilibopencm3/include \
...
OBJSL		= stm32_sine.o hwinit.o stm32scheduler.o params.o terminal.o terminal_prj.o \
		   ...
		   inverter.pb.o pb_common.o pb_decode.o pb_encode.o
